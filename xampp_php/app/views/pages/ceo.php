...
<div class="row g-4">
  <section class="col-lg-6" aria-labelledby="flight-ceo-title">
    <div class="card p-3">
      <h2 id="flight-ceo-title" class="h5">Crear vuelo</h2>
      <form method="post" action="<?php echo BASE_URL; ?>/index.php?page=ceo" class="row g-2 needs-validation" novalidate>
        ...
        <div class="col-md-6"><label class="form-label" for="flight_airline">ID Aerolinea</label><input id="flight_airline" type="number" name="airline_id" min="1" class="form-control" required></div>
  ...
  <section class="col-lg-6" aria-labelledby="promo-ceo-title">
    <div class="card p-3">
      <h2 id="promo-ceo-title" class="h5">Crear promocion</h2>
      <form method="post" action="<?php echo BASE_URL; ?>/index.php?page=ceo" class="needs-validation" novalidate>
        ...
        <div class="mb-2"><label class="form-label" for="promo_airline">ID Aerolinea</label><input id="promo_airline" type="number" min="1" name="airline_id" class="form-control" required></div>
  ...
  <section class="col-lg-12" aria-labelledby="flights-list-ceo-title">
    <div class="card p-3">
      <h2 id="flights-list-ceo-title" class="h5">ABMC Vuelos</h2>
      <?php foreach ($flights as $flight): ?>
        <form method="post" action="<?php echo BASE_URL; ?>/index.php?page=ceo" class="row g-2 border rounded p-2 mb-2">
          ...
          <div class="col-md-2"><input type="number" min="1" name="airline_id" class="form-control" value="<?php echo (int) $flight['airline_id']; ?>" required></div>
          ...
          <div class="col-md-2"><input type="number" step="0.01" name="price" class="form-control" value="<?php echo (float) $flight['price']; ?>" required></div>
          ...
          <div class="col-md-10"><small class="text-muted">Disponibles: <?php echo (int) $flight['available_seats']; ?></small></div>
  ...
  <section class="col-lg-6" aria-labelledby="promo-list-ceo-title">
    <div class="card p-3">
      <h2 id="promo-list-ceo-title" class="h5">ABMC Promociones</h2>
      <?php foreach ($promotions as $promotion): ?>
        <form method="post" action="<?php echo BASE_URL; ?>/index.php?page=ceo" class="border rounded p-2 mb-2">
          ...
          <div class="row g-2">
            <div class="col-md-3"><input type="number" min="1" name="airline_id" class="form-control" value="<?php echo (int) $promotion['airline_id']; ?>" required></div>
            <div class="col-md-4"><input name="title" class="form-control" value="<?php echo htmlspecialchars($promotion['title']); ?>" required></div>
            <div class="col-md-3"><input type="number" step="0.01" min="1" max="100" name="discount_percent" class="form-control" value="<?php echo (float) $promotion['discount_percent']; ?>" required></div>
            ...
            <div class="col-12 small text-muted">Estado admin: <?php echo htmlspecialchars($promotion['status']); ?></div>
  ...
  <section class="col-lg-6" aria-labelledby="reports-ceo-title">
    <div class="card p-3">
      <h2 id="reports-ceo-title" class="h5">Reportes</h2>
